<?php /*a:3:{s:87:"/Users/jon/Documents/项目汇总/车自主/application/index/view/user/registered.html";i:1543243601;s:82:"/Users/jon/Documents/项目汇总/车自主/application/index/view/public/css.html";i:1541004298;s:81:"/Users/jon/Documents/项目汇总/车自主/application/index/view/public/js.html";i:1541081189;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
            ...
            <div class="block-content" sign="page_login" avalonctrl="page_login">
                ...
                <div class="row">
                    <div class="contact_content">
                        ...
                        <div class="row mt_10 ">
                            <input type="button" @click="login" class="text-b determine no-border-l" value="注册">
                        </div>
                        <div style="text-align: center;margin-top: 20px">
                            <a href="<?php echo url('index/user/login'); ?>">已经有账号？去登录</a>
        ...
        methods: {
            login() {
                ...
                if (_this.temp.password.length < 6) {
                    _this.$toast('注册密码不能少于6位');
                    return false
                }
                axios.post('/index/user/registered', _this.temp).then(res => {
                    if (res.data.status == 200) {
                        _this.$dialog.confirm({
                            title: '消息',
                            message: '亲爱的小伙伴，感谢注册！车之界Carworld为您提供以下贴心服务.汽车知识、购车秘籍、选购技巧、年检、违章处理、行业新闻、热点事件、粉丝福利……现在就去登录，'
                        }).then(() => {
                            // on confirm
