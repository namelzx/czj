<?php /*a:3:{s:86:"/Users/jon/Documents/项目汇总/车自主/application/index/view/examcar/choose.html";i:1543073791;s:82:"/Users/jon/Documents/项目汇总/车自主/application/index/view/public/css.html";i:1543286450;s:81:"/Users/jon/Documents/项目汇总/车自主/application/index/view/public/js.html";i:1541081189;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<div class="content">
    ...
    <div class="block"><!--each141044148862:start-->
        <div data-include-loaded="loaded" data-include-rendered="rendered"><!--ms-include-->
            ...
            <div class="" sign="page_car" style="height: 100%;" avalonctrl="page_car" id="app">
                    ...
                    <van-popup v-model="show">
                        ...
                        <van-cell-group>
                            <template v-for="info in carinfo">
                                <van-cell @click="handeinfo(info.id,info)" :title="info.name" :value="info.year"
                                          :label="info.displacement"/>
                            </template>
                        </van-cell-group>
                    </van-popup>
                </div>
    ...
    var app = new Vue({
        ...
        methods: {
            ...
            handeinfo(id, info) {
                ...
                setCookie('usedcar_name', carname)
                this.show = false
                // var str = JSON.parse(getCookie('shop_info'))
                window.location.href = '/index/examcar/usedcar/'
