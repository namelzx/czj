<?php /*a:3:{s:84:"/Users/jon/Documents/项目汇总/车自主/application/admin/view/deal/usedcar.html";i:1543136668;s:85:"/Users/jon/Documents/项目汇总/车自主/application/admin/view/public/header.html";i:1543127366;s:85:"/Users/jon/Documents/项目汇总/车自主/application/admin/view/public/footer.html";i:1541487880;}*/ ?>
<!--包含头部文件-->
<!DOCTYPE HTML>
<html>
<head>
...
<body>
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 审核二手机估价列表</nav>
    ...
    <div class="mt-20">
        <table class="table table-border table-bordered table-bg table-hover table-sort">
            ...
            <tr class="text-c">
                ...
                <td><?php echo htmlentities($vo['mileage']); ?></td>
                <td><?php echo htmlentities($vo['transmission']); ?></td>
                <td><?php echo htmlentities($vo['color']); ?></td>
                <td><?php echo htmlentities($vo['institutions']); ?></td>
                ...
                <td class="td-manage"><a style="text-decoration:none" class="ml-5"
                                         onclick="o2o_del('/admin/deal/ustatus?id=<?php echo htmlentities($vo['id']); ?>&status=1','审核通过?')"
